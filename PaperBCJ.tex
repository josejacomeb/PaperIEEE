...
Dataset Desciption:
\\
For the model we have two categories, the first maize in its initial stage, and the second weed, All images for the dataset were obtained from maize cultivations in their initial stage in Pillaro canton, where they had a total of 2000 images, of which 1600 images were used for the training and 400 for the validation, once obtained the images are processed by openCV to segment them and can be obtained as follows:
\\
\includegraphics[width=3in]{im1}\\[1ex]
