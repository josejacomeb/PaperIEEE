...
For the validation phase, a fifth part of the total image set of each class was chosen, resulting in the following chart with the dataset distribution.\\
