...
The programs / packages used were OpenCV and Qt, for the acquisition, segmentation of images, Cafe for the realization of neural networks,
\\
...
\subsection{Dataset Desciption}
	\begin{figure}[!t]
	For the model we have two categories, the first maize in its initial stage, and the second weed, All images for the dataset were obtained from maize cultivations in their initial stage in Pillaro canton, where they had a total of  2225 images, of which 1622 images were of maize and 603 of weed, once obtained the images are processed by openCV to segment them and can be obtained as follows:
	\\
