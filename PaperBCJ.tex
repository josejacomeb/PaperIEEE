...
For the validation phase, a fifth part of the total image set of each class was chosen, resulting in the dataset distribution shown in Table \ref{table:1}.
...
In order to have adequate image processing that could be implemented to work in real time, the number of network filter layers was reduced from 64 to 16, reducing the number of parameters to be computed during the classification. A classification time reduced by 2.5 times compared the original Net of 64 filters was obtained. This change had a small impact in the training accuracy of the net, its value increased 1 \% in comparison to the original net. \\
...
The study demonstrated that performimg geometrical transformations to the dataset images improves plant classification accuracy since the plants will have different orientations in the crop field. \\
